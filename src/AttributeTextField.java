...
public class AttributeTextField implements PdfPCellEvent
{
     ...
     */
    public AttributeTextField(String tf) {
        this.name = tf;
    }
    ...
    public void cellLayout(PdfPCell cell, Rectangle rectangle, PdfContentByte[] canvases) {
        ...
        TextField text = new TextField(writer, rectangle, this.name);
        text.setBackgroundColor(new GrayColor(0.75f));
        
        
        text.setText("");
        text.setMaxCharacterLength(2);
        text.setFontSize(11);
        text.setAlignment(Element.ALIGN_CENTER);
        text.setBackgroundColor(new BaseColor(255,255,255));
        /*
        switch(tf) 
        {
        case "1":
